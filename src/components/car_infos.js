...
export const sous_contrat =[   
   ...
   { key:21,name:'KM_Limité_à	KM (+) (-)      ',label:'KM_Limite_a_KM' , type:"text"},
   { key:21,name:'Prestataire                  ',label:'Prestataire' , type:"text"},
   { key:21,name:'Fonct_SERVICE              ',label:'Fonct_SERVICE' , type:"text"},]
...
export const Conducteur = [        
    ...
    { key:10,name:'Grade____dsfasdmlaskdmclmsclkmlkasm',label:'Grade' , type:"text"},
...
/*     {name:'Make ',label:'make' , type:"text"},
    ...
    { key:11,name:'Contrat',label:'Contrat_no' , type:"text"},
    { key:12,name:'Parc',label:'No_Parc' , type:"text"},
    { key:13,name:'Année',label:'Annee' , type:"number"},
    { key:9,name:'A.O. n°',label:'A_O_no' , type:"text"},
    { key:14,name:'Montant Mensuel H.T.',label:'Montant_Mensuel_H_T' , type:"text"},
    { key:15,name:'Date Début',label:'Date_Début' , type:"date"},
    { key:16,name:'Date Fin',label:'ate_Fin' , type:"date"},
    { key:17,name:'Date Prévue de la Restitution',label:'Date_Prévue_de_la_Restitution' , type:"date"},
    { key:18,name:'Date Effective de la Restitution',label:'Date_Effective_de_la_Restitution' , type:"date"},
    { key:20,name:'KM Date de Retour',label:'KM_Date_de_Retour' , type:"number"},
    { key:21,name:'Contrat',label:'Contrat_échu_En_Cours' , type:"text"},
]
export const ops={
